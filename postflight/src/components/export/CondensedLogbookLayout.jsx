...
export default function CondensedLogbookLayout({ user, flights }) {
            ...
            <div className="page-break-after">
                <div className="h-screen flex flex-col justify-center items-center text-center">
                    <div>
                        ...
                        <h2 className="text-2xl text-gray-700 mb-4">Flight Logbook</h2>
                        {dateRangeString && (
                            ...
                            {(flights || []).map(flight => {
                                ...
                                return (
                                    <TableRow key={flight.id} className="page-break-inside-avoid">
                                        <TableCell className="whitespace-nowrap">{format(parseISO(flight.date), "yyyy-MM-dd")}</TableCell>
                                        <TableCell>
                     ...
                     <Table>
                        <TableFooter>
                            <TableRow className="bg-slate-50 font-bold border-t-2 border-black">
                                ...
                                <TableCell /> {/* Empty cell for Remarks column */}
                            </TableRow>
                        </TableFooter>
                    </Table>
                </div>
